                      ...
                      child: state.selectedDocContent == null
                          ...
                          : Markdown(
                              ...
                              styleSheet: MarkdownStyleSheet(
                                p: GoogleFonts.outfit(color: Colors.white70, fontSize: 14, height: 1.4),
                                h1: GoogleFonts.outfit(color: Colors.white, fontSize: 22, fontWeight: FontWeight.bold),
                                h2: GoogleFonts.outfit(color: AppTheme.accentBlue, fontSize: 18, fontWeight: FontWeight.bold),
                                h3: GoogleFonts.outfit(color: AppTheme.primaryPurple, fontSize: 15, fontWeight: FontWeight.bold),
                                code: GoogleFonts.firaCode(backgroundColor: AppTheme.surfaceLight, color: const Color(0xFF00FF66)),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Documentación Viva', style: GoogleFonts.outfit(fontWeight: FontWeight.bold, fontSize: 18)),
        actions: [
          IconButton(
      ...
      body: BlocBuilder<DocsCubit, DocsState>(
        builder: (context, state) {
          ...
          final filteredDocs = state.documents.where((d) {
            ...
            return d.title.toLowerCase().contains(q) || d.category.toLowerCase().contains(q);
          }).toList();
            ...
            children: [
              ...
              Padding(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    prefixIcon: const Icon(Icons.search_rounded, color: AppTheme.accentBlue, size: 20),
                    filled: true,
                    fillColor: AppTheme.surface,
                    isDense: true,
                    border: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(10),
                      borderSide: BorderSide(color: AppTheme.border.withOpacity(0.6)),
                    ),
                  ),
              ...
              Expanded(
                child: filteredDocs.isEmpty
                    ? Center(
                        child: Text('No se encontraron documentos.', style: GoogleFonts.outfit(color: AppTheme.textSecondary)),
                      )
                    : ListView.builder(
                        ...
                        itemBuilder: (context, idx) {
                          ...
                          return Card(
                            ...
                            child: ListTile(
                              leading: const Icon(Icons.description_rounded, color: AppTheme.primaryPurple, size: 22),
                              title: Text(
                                doc.title,
