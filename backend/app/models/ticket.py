...
class Sprint(Base):
    ...
    status = Column(SQLEnum(SprintStatus, name="sprint_status"), default=SprintStatus.planificado, nullable=False)
...
class Ticket(Base):
    ...
    type = Column(SQLEnum(TicketType, name="ticket_type"), default=TicketType.feature, nullable=False)
    area = Column(SQLEnum(TicketArea, name="ticket_area"), nullable=True)
    priority = Column(SQLEnum(TicketPriority, name="ticket_priority"), default=TicketPriority.media, nullable=False)
    status = Column(SQLEnum(TicketStatus, name="ticket_status"), default=TicketStatus.backlog, nullable=False)
    assignee = Column(String(120), nullable=True)
    reporter = Column(String(120), nullable=False, default="admin")
    source = Column(SQLEnum(TicketSource, name="ticket_source"), default=TicketSource.manual, nullable=False)
...
class TicketEvent(Base):
    ...
    kind = Column(SQLEnum(EventKind, name="event_kind"), nullable=False)
